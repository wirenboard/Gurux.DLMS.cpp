...
int CGXDLMSTokenGateway::GetValue(CGXDLMSSettings& settings, CGXDLMSValueEventArg& e)
{
    CGXByteBuffer bb;
    int ret;
    CGXDLMSVariant tmp;
...
int CGXDLMSTokenGateway::SetValue(CGXDLMSSettings& settings, CGXDLMSValueEventArg& e)
{
    int ret;
    CGXByteBuffer bb;
    CGXDLMSVariant tmp;
