...
typedef enum
{
    ...
    DLMS_TRANSLATOR_TAGS_EXCEPTION_RESPONSE = 0xFF83,
    DLMS_TRANSLATOR_TAGS_STATE_ERROR = 0xFF84,
    DLMS_TRANSLATOR_TAGS_PBLOCK = 0xFF85,
    DLMS_TRANSLATOR_TAGS_CONTENT = 0xFF86,
    DLMS_TRANSLATOR_TAGS_SIGNATURE = 0xFF87
