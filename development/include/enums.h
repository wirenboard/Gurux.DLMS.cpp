 ...
 * Used priority.
 */
enum GXDLMS_PRIORITY
{
    // Normal priority.
    GXDLMS_PRIORITY_NORMAL = 0,

    // High priority.
    GXDLMS_PRIORITY_HIGH = 1
};

enum GXDLMS_SERVICECLASS
{
    GXDLMS_SERVICECLASS_UN_CONFIRMED = 0,
    GXDLMS_SERVICECLASS_CONFIRMED = 1
};
...
{
    //General
    GXDLMS_INTERFACETYPE_HDLC = 0,
    // IEC 62056-47 COSEM transport layers for IPv4 networks
    GXDLMS_INTERFACETYPE_WRAPPER= 0x1
};
