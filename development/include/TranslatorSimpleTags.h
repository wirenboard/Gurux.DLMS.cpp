...
public:
    ...
    static void GetLnTags(DLMS_TRANSLATOR_OUTPUT_TYPE type, std::map<unsigned long, std::string>& list)
    {
        ...
        list[(DLMS_COMMAND_METHOD_REQUEST << 8) | DLMS_ACTION_REQUEST_TYPE_NEXT_BLOCK] = "ActionRequestForNextPBlock";
        list[(DLMS_COMMAND_METHOD_REQUEST << 8) | DLMS_ACTION_REQUEST_TYPE_WITH_LIST] = "ActionRequestWithList";
        list[DLMS_COMMAND_METHOD_REQUEST << 8 | DLMS_ACTION_REQUEST_TYPE_WITH_FIRST_BLOCK] = "ActionRequestWithFirstBlock";
        list[DLMS_COMMAND_METHOD_REQUEST << 8 | DLMS_ACTION_REQUEST_TYPE_WITH_LIST_AND_FIRST_BLOCK] = "ActionRequestWitListAndFirstBlock";
